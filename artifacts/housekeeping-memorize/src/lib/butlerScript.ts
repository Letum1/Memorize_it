export const STORAGE_KEY_BUTLER = "butler-names-v2";
...
export function loadNames(): ButlerNames {
  try {
    ...
    // Migrate old v1 data
    if (parsed.receptionistName === undefined) {
      parsed.receptionistName = parsed.butlerName;
    }
    if (parsed.sameActor === undefined) {
      parsed.sameActor = true;
    }
    if (parsed.guestGender === undefined) {
      parsed.guestGender = "female";
    }
...
function title(n: ButlerNames): string {
  return n.guestGender === "male" ? "Sir" : "Ma'am";
}

function spouseTitle(n: ButlerNames): string {
  return n.guestGender === "male" ? "Mr." : "Mrs.";
}

export function buildScript(n: ButlerNames): Scene[] {
  const b = n.butlerName;
  const r = n.sameActor ? n.butlerName : n.receptionistName;
  const g = n.guestName;
  const city = n.guestCity;
  const hotel = n.hotelName;
  const T = title(n);
  const S = spouseTitle(n);

  return [
    {
      title: "Arrival of the Guest",
      lines: [
        { role: "butler", text: `Good morning, ${T}. Welcome to ${hotel}. My name is ${b}, your butler for today. May I assist you with your luggage?` },
        { role: "guest", text: "Yes, please." },
        { role: "butler", text: `Thank you, ${T}. Please allow me to escort you to the front desk for your check-in.` },
      ],
    },
    {
      title: "Front Desk Check-In",
      lines: [
        { role: "receptionist", text: `Good morning, ${T}. Welcome to ${hotel}. How may I assist you?` },
        { role: "guest", text: "Good morning. I would like to check in." },
        { role: "receptionist", text: `Certainly, ${T}. May I have your name, please?` },
        { role: "guest", text: `My name is ${g}${city ? ` from ${city}` : ""}.` },
        { role: "receptionist", text: `One moment, please… ${S} ${g}, I can see your reservation here. You have booked one Junior Deluxe Room for tonight.` },
        { role: "guest", text: "Yes, that's correct." },
        { role: "receptionist", text: "May I please see a valid ID?" },
        { role: "guest", text: "Of course." },
        { role: "note", text: `(Guest hands ID to the receptionist${n.sameActor ? "" : ` — ${r}`})` },
        { role: "receptionist", text: `Thank you, ${T}. Kindly sign here and write your contact number.` },
        { role: "receptionist", text: `${S} ${g}, your room number is 106. Here is your key card, along with your ID and your breakfast voucher for two persons. Breakfast is served tomorrow morning. Is there anything else I may assist you with?` },
    ...
    },
    {
      ...
      lines: [
        { role: "butler", text: `${T}, please allow me to escort you to your room.` },
    ...
    },
    {
      ...
      lines: [
        { role: "butler", text: `We are now in front of your room, ${T}. May I have your key card?` },
        { role: "note", text: "(Enters room, places luggage on rack)" },
        { role: "butler", text: `Please have a seat, ${T}.` },
    ...
    },
    {
      ...
      lines: [
        { role: "butler", text: `${T}, would you like me to assist you with unpacking your clothes?` },
        { role: "guest", text: "Yes, please." },
        ...
        { role: "butler", text: `Thank you, ${T}. May I take my leave?` },
    ...
    },
    {
      ...
      lines: [
        ...
        { role: "butler", text: `${T}, I understand that you requested assistance with packing your belongings.` },
    ...
    },
    {
      ...
      lines: [
        { role: "butler", text: `${T}, our guest is here for checking out.` },
        { role: "receptionist", text: `Good morning, ${T}. Are you checking out today?` },
